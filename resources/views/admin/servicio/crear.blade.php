    ...
    <h1>
        ...
        <div class="box-tools pull-right">
            <a href="{{route('servicio')}}" class="btn btn-block btn-info btn-sm">{{-- boton para ir a otra tabla --}}
                ...
                <i class="fa fa-fw fa-reply-all"></i>Ver Lista de Servicios
              </a>
        </div>
    </h1>
</div>
...
<div class="row">
    <div class="col-xs-12">
        ...
        <form class="form-horizontal" role="form" id="form-general"  action="{{route ('guardar_servicio')}}"  method="POST" enctype="multipart/form-data">
            @csrf
