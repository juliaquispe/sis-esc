...
@endsection
@section('scripts')
<script src="{{asset("assets/pages/scripts/servicio/validar.js")}}" type="text/javascript"></script>
@endsection
@section('contenido')
<div class="page-header">
    <h1>
        ...
        <div class="box-tools pull-right">
            <a href="{{route('servicio')}}" class="btn btn-block btn-info btn-sm">{{-- boton para ir a otra tabla --}}
                <style type="text/css">
                    .btn{
                    padding: 5px;
                    font-weight: 500;
                ...
                <i class="fa fa-fw fa-reply-all"></i>Volver a Lista de Servicios
              </a>
        </div>
    </h1>
</div>
...
<div class="row">
    <div class="col-xs-12">
        ...
        <form class="form-horizontal" role="form" id="form-general" action="{{route('actualizar_servicio', ['id' => $servicio->id])}}"  method="POST" enctype="multipart/form-data">
            @csrf @method("put")
